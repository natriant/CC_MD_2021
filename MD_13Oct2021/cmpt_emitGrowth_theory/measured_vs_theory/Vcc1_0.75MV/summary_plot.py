...
Backgorund growth rate from coast 1 setting 0 is subtracted.
'''
...
ax.plot([-50, 50], [-50, 50], ls="--", c=".3", lw=3)#, label=r'$\mathrm{y=x}$')
...
plt.tight_layout()
#plt.axis('equal')
plt.savefig('CC_MD_emitGrowth_2018vs2021_v3.png',  bbox_inches="tight")

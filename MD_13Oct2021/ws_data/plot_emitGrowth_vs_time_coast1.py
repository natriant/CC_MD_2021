...
coasts = ['coast1_setting0', 'coast1_setting1', 'coast1_setting2', 'coast1_setting3', 'coast1_setting3b']
...
# The feature of the “Best channel” from the wirescanner firmware does not work correctly yet (23Sep2021)
    ...
    ax.set_title(f'Coast1, Set {my_set}')
    ax.set_xlabel('Time')
...
plt.savefig(f'emit_grwoth_vs_time_coast1_set{my_set}.png')
